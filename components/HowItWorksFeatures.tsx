...
// import downlight from "@/app/svg/down-light.svg"
         ...
         <div className="container">
            <div className="mx-auto max-w-6xl">
               <div className="mx-auto my-12 grid h-full items-center gap-10 lg:grid-cols-2">
                           ...
                           >
                              ...
                              <div className="relative flex items-center">
                                 ...
                                 <div>
                                    ...
                                    <AccordionTrigger className="justify-start pl-0 text-left text-muted-foreground text-[16px] leading-4">
                                       {item.content}
                                    </AccordionTrigger>
                                 </div>
                              </div>
                  ...
                  <div
                     className={` relative h-[350px] min-h-[200px] w-auto  ${ltr && 'lg:order-1'
                        }`}
                  >
                     {data[currentIndex]?.image
                        ? (
                           <motion.img
                              ...
                              alt="feature"
                              className="aspect-auto size-full rounded-xl border border-neutral-300/50 object-cover  p-1 shadow-lg"
                  ...
                  <Image src={downlight} width={1920} height={1080} alt="Light effect" className="scale-[1.5] opacity-[0.7]" />
                </div> */}
                  </div>
